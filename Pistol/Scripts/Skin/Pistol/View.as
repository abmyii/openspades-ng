	...
	BasicViewWeapon {
		...
		ViewPistolSkin(Renderer@ r, AudioDevice@ dev){
			...
			@sightModel1 = renderer.RegisterModel
				("Models/Weapons/Pistol/Sight1.kv6");
			@sightModel2 = renderer.RegisterModel
				("Models/Weapons/Pistol/Sight2.kv6");

			@fireSound = dev.RegisterSound
				("Sounds/Weapons/Pistol/FireLocal.opus");
			@fireFarSound = dev.RegisterSound
				("Sounds/Weapons/Pistol/FireFar.opus");
			@fireStereoSound = dev.RegisterSound
				("Sounds/Weapons/Pistol/FireStereo.opus");
			@reloadSound = dev.RegisterSound
				("Sounds/Weapons/Pistol/ReloadLocal.opus");

			@fireSmallReverbSound = dev.RegisterSound
				("Sounds/Weapons/Pistol/V2AmbienceSmall.opus");
			@fireLargeReverbSound = dev.RegisterSound
				("Sounds/Weapons/Pistol/V2AmbienceLarge.opus");
		}
		...
		void AddToScene() {
			...
			leftHand = mat * Vector3(1.f, 5.f, 3.f);
			rightHand = mat * Vector3(0.f, 4.f, 4.f);
			...
			if(AimDownSightStateSmooth > 0.8f){
				mat = AdjustToAlignSight(mat, Vector3(-1.f, 10.f, -3.6f), (AimDownSightStateSmooth - 0.8f) / 0.2f);
			}

			ModelRenderParam param;
			Matrix4 weapMatrix = eyeMatrix * mat;
			param.matrix = weapMatrix * CreateScaleMatrix(0.5f) *
				CreateTranslateMatrix(-1.f, 0.f, 0.f);
